...
const FindUs = () => {
    return (
        <section className='py-20'>
            <h2 className='text-center text-4xl font-bold pb-10'>Find Us</h2>
            <div className='block md:flex gap-10 space-y-5 md:space-y-0 items-center justify-between container mx-auto px-5 md:px-0'>
                <div className="left map">
                    <iframe className='rounded-lg w-full md:w-3xl h-72' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d57628.94057423676!2d80.30331983551154!3d25.478059633255505!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399cceefe1f614ff%3A0x53644b0b29880d03!2sBanda%2C%20Uttar%20Pradesh%20210001!5e0!3m2!1sen!2sin!4v1746558158005!5m2!1sen!2sin" style={{ border: 0 }} loading="lazy" referrerPolicy="no-referrer-when-downgrade" allowFullScreen=""></iframe>
                </div>
                <div className="right p-5 bg-gray-100 rounded-lg flex flex-col gap-3">
                    <div className="heading">
                        <h2 className='text-2xl font-semibold'>Bhatnagar Opticals</h2>
                    </div>
