        ...
        <section className=' bg-red-900'>
            <div className='container mx-auto h-screen flex flex-col gap-5 justify-center items-center'>
                ...
                <div className="buttons px-5 flex flex-col md:flex md:flex-row gap-3 w-full justify-center">
                    <Link href={'#find-us'} className='flex items-center justify-center gap-3 px-6 py-3 rounded-full bg-white hover:bg-blue-50 text-blue-500 font-semibold transition-all duration-300'>
                        <span className='text-red-500'>
                            <FaMapPin />
                        </span>
                        <p>Get Directions</p>
                    </Link>
                    <Link href={'#book-now'} className='inline-flex items-center justify-center gap-3 px-6 py-3 rounded-full bg-red-500 hover:bg-red-600 text-white font-semibold transition-all duration-300'><span><FaEye /></span><p>Book Free Eye Test</p></Link>
                </div>
            </div>
        </section>
    )
